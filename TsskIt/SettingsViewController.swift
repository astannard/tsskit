...
//  TsskIt
//
//  Created by Andy Stannard on 26/02/2015.
...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var captilizeTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.captilizeTableView.scrollEnabled = false
        ...
        //This is overriding the default back button item so that we can have one that says done instead
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if tableView == self.captilizeTableView {
